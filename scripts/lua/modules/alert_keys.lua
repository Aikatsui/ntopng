...
local alert_keys = {
   ntopng = {
      ...
      alert_internals                      = {NO_PEN, BASE_ID + 12},
      ...
      alert_web_mining                     = {NO_PEN, BASE_ID + 45},
      alert_host_log                       = {NO_PEN, BASE_ID + 46},
      alert_attack_mitigation_via_snmp     = {NO_PEN, BASE_ID + 47},
      alert_iec104_error                   = {NO_PEN, BASE_ID + 48},
      alert_too_many_retransmissions       = {NO_PEN, BASE_ID + 49}, -- No longer used
      alert_lateral_movement               = {NO_PEN, BASE_ID + 50},
      alert_list_download_succeeded        = {NO_PEN, BASE_ID + 51},
      alert_no_if_activity                 = {NO_PEN, BASE_ID + 52}, -- scripts/plugins/alerts/internals/no_if_activity
      alert_unexpected_new_device          = {NO_PEN, BASE_ID + 53}, -- scripts/plugins/alerts/security/unexpected_new_device
      alert_shell_script_executed          = {NO_PEN, BASE_ID + 54}, -- scripts/plugins/endpoints/shell_alert_endpoint
      alert_periodicity_update             = {NO_PEN, BASE_ID + 55}, -- pro/scripts/enterprise_l_plugins/alerts/network/periodicity_update
      alert_dns_positive_error_ratio       = {NO_PEN, BASE_ID + 56}, -- pro/scripts/enterprise_l_plugins/alerts/network/dns_positive_error_ratio
      alert_fail2ban_executed              = {NO_PEN, BASE_ID + 57}, -- pro/scripts/pro_plugins/endpoints/fail2ban_alert_endpoint
      alert_flows_flood_attacker           = {NO_PEN, BASE_ID + 58},
      alert_flows_flood_victim             = {NO_PEN, BASE_ID + 59},
      alert_tcp_syn_flood_attacker         = {NO_PEN, BASE_ID + 60},
      alert_tcp_syn_flood_victim           = {NO_PEN, BASE_ID + 61},
      alert_tcp_syn_scan_attacker          = {NO_PEN, BASE_ID + 62},
      alert_tcp_syn_scan_victim            = {NO_PEN, BASE_ID + 63},
      alert_contacted_peers                = {NO_PEN, BASE_ID + 64},
      alert_unexpected_behaviour           = {NO_PEN, BASE_ID + 65},
