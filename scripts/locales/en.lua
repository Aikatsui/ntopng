local lang = {
  ...
  ["countries"] = "Countries",
  ["create"] = "Create",
  ["current_filter"] = "Disable Alerts For",
  ["dark"] = "Dark",
  ...
  ["delete_disabled_alerts"] = "Delete Disabled Alerts",
  ...
  ["show_alerts"] = {
    ...
    ["confirm_delete_filtered_alerts"] = "Stored alerts matching the specified filter be deleted.",
