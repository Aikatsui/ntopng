local lang = {
  ...
  ["alert_messages"] = {
    ...
    ["flow_flood_attacker"] = "%{entity}%{host_category} is a flow flooder [%{value} &gt; %{threshold} flows sent]",
    ["flow_flood_victim"] = "%{entity}%{host_category} is under flow flood attack [%{value} &gt; %{threshold} flows received]",
    ...
    ["http_download_failed"] = "Throughput check failed",
    ...
    ["remote_to_local_insecure_proto_breed"] = "Protocol Safety: %{proto}",
    ["remote_to_local_insecure_proto_category"] = "Protocol Id: %{proto_id}; Protocol Category: %{proto}",
    ...
    ["syn_flood_attacker"] = "%{entity}%{host_category} is a SYN flooder [%{value} &gt; %{threshold} SYN sent]",
    ["syn_flood_victim"] = "%{entity}%{host_category} is under SYN flood attack [%{value} &gt; %{threshold} SYN received]",
    ["syn_scan_attacker"] = "%{entity}%{host_category} is a SYN Scan attacker [%{value} &gt; %{threshold} SYN sent]",
    ["syn_scan_victim"] = "%{entity}%{host_category} is under SYN Scan [%{value} &gt; %{threshold} SYN received]",
  ...
  ["alerts_dashboard"] = {
    ...
    ["known_proto_on_non_std_port"] = "Protocol on Non-Standard Port",
    ...
    ["ndpi_smb_insecure_version_title"] = "SMB Insecure Version",
    ...
    ["too_low_replies_received"] = "%{entity}%{host_category} has sent %{requests} but received %{replies} [%{granularity} ratio: %{ratio}%%]",
  ...
  ["flow_details"] = {
    ...
    ["additional_alert_type"] = "Additional Flow Status",
    ...
    ["normal"] = "Normal",
    ["not_purged"] = "Not purged from memory",
  ...
  ["prefs"] = {
    ...
    ["max_num_days_before_delete_alert_description"] = "The maximum number of days before an alert is deleted. All the alerts older then that period will be automatically deleted both at startup and periodically by ntopng",
    ["max_num_days_before_delete_alert_title"] = "Maximum Number of Days Before Delete",
  ...
  ["scripts_list"] = {
    ...
    ["config"] = "Config",
    ["exclusion_list"] = "Here are listed the currently excluded alerts (This alert won't be triggered for those inside this list)",
  ...
  ["show_alerts"] = {
    ...
    ["confirm_delete_filtered_alerts"] = "Alerts matching the filter will be deleted.",
    ["confirm_filter_alert"] = "Do you really want to filter the alert using the specified fields? New alerts with the same fields won't be triggered.",
