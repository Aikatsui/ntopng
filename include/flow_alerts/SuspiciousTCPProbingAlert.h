...
#ifndef _SUSPICIOUS_TCP_PROBING_ALERT_H_
#define _SUSPICIOUS_TCP_PROBING_ALERT_H_
...
class SuspiciousTCPProbingAlert : public FlowAlert {
 ...
 SuspiciousTCPProbingAlert(FlowCallback *c, Flow *f, AlertLevel s) : FlowAlert(c, f, s) { };
