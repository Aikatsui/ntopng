...
#ifndef _DATA_EXFILTRATION_H_
#define _DATA_EXFILTRATION_H_

#include "ntop_includes.h"

class DataExfiltration : public FlowCallback {
 private:
  
 public:
  DataExfiltration() : FlowCallback(ntopng_edition_community,
  ...
  FlowCallbackStatus getStatus() const { return status_data_exfiltration;          }
};
