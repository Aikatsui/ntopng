...
class NedgeBlockedFlow : public FlowCallback {
 private:
  
 public:
  NedgeBlockedFlow() : FlowCallback(false /* All interfaces */, false /* Don't exclude for nEdge */, true /*  only for nEdge */,
					   true /* has_protocol_detected */, false /* has_periodic_update */, false /* has_flow_end */) {};
  ~NedgeBlockedFlow() {};

  void protocolDetected(Flow *f);
  
  std::string getName()          const { return(std::string("nedge_blocked")); }
