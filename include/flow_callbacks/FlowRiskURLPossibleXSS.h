...
class FlowRiskURLPossibleXSS : public FlowRisk {
 private:
  ...
  FlowAlertType getAlertType() const { return alert_ndpi_url_possible_xss; }
 ...
 public:
  ...
  FlowAlert *buildAlert(Flow *f) { return new FlowRiskURLPossibleXSSAlert(this, f, getSeverity()); }
