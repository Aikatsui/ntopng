...
#ifndef _TLS_UNSAFE_CIPHERS_H_
#define _TLS_UNSAFE_CIPHERS_H_

#include "ntop_includes.h"

class TLSUnsafeCiphers : public FlowCallback {
 private:
  
 public:
 TLSUnsafeCiphers() : FlowCallback(ntopng_edition_community,
  ...
  FlowAlertType getAlertType() const { return alert_tls_unsafe_ciphers;          }
};
