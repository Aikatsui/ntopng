...
class ElephantFlow : public FlowCallback {
 ...
 public:
 ElephantFlow() : FlowCallback(false /* All interfaces */, false /* Don't exclude for nEdge */, false /* NOT only for nEdge */,
  ...
  FlowCallbackStatus getStatus() const { return status_elephant_local_to_remote; }
};
